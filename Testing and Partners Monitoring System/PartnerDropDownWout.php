...
if(isset($_POST['redirect'])){
    header('Location: '.$_POST['linkWout']);
    exit;
}
?>
<html>
...
<h3 align = "center";>Partners With Incomplete Documentation</h3>
...
<div class="container" style="width: 429px; margin-left: 530px;">
  ...
  <form class="form" action="" method="post" enctype="multipart/form-data" autocomplete ="off">
    ...
    <select name="linkWout" required>
       <option value="" >--Select Document--</option>
       <option value="PartnerMOAWout.php">MOA</option>   
       <option value="PartnerNDAWout.php">NDA</option>
       <option value="PartnerWOWout.php">WOrk Order</option>
       <option value="PartnerFSDRequestWout.php">FSD Request</option>
       <option value="PartnerChargeSettingsWout.php">Charge Settings</option>
       <option value="PartnerHDChecklistWout.php">Helpdesk Checklist</option>
       <option value="PartnerAccessFormWout.php">Access Form</option>
    </select>
