...
$sql = "SELECT PartnersName FROM `partnerslist` WHERE ChargeSettings = 'with' ORDER BY PartnersName";
...
$sql1 = "SELECT COUNT(PartnersName) AS total FROM partnerslist WHERE ChargeSettings = 'with';";
...
<div class="navbar">
  <a href="HomePage.php"><h6 style="margin-top: 0px; margin-bottom: 0px;">Home</h6></a>
	...
	<table class="data-table">
		<caption class="title"><h1>Partner with Charge Settings Document</h1></caption>
		<thead>
			<tr>
				<th>Partners Name</th>
			</tr>
