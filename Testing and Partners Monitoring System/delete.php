...
if(isset($_POST['delete']))
{
   ...
   $query = "DELETE from `listofprojects` WHERE `ProjectNum` = $ProjectNum";
...
<h3 align = "center";>Delete Form</h3>
    ...
    <body>
<p align = "center";>Please put your Project Number to Delete:</p>
...
<p><input name="delete" type="submit" value="Delete" style="width: 200px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
